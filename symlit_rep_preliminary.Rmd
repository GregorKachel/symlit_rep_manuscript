...
symlitrep.ind.correct.table.data  <- symlitrep.data %>% 
  ...
  group_by(study, agecat, conditionlong, subid) %>%
  arrange(study, agecat, conditionlong) %>%
...
s1.symlitrep.correct.table.data$conditionlong <- as.character(s1.symlitrep.correct.table.data$conditionlong)
s1.symlitrep.correct.table.data$conditionlong[duplicated(s1.symlitrep.correct.table.data$conditionlong)] <- ""
