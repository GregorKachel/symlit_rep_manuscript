...
conceptual and abstract symbol-referent relationships, it will be
helpful to gradually reduce resemblance between cue and target. As an
alternative to using varying levels of realism in designing
communicative cues [@callaghan2000factors], it is also possible to
reduce cues such that they only present part of their respective target
as often occurs naturally when streamlining communication and developing
conventions [@goldin1977development]. Part-whole relationships on the
level of geometric figures could be an ideal target for an investigation
into slightly abstract symbol-reference relationships as shape
recognition and naming are robust in the third and fourth year
[@ZAMBRZYCKA2017144; @verdine2017shape; @verdine2016shape] and the
ability to mentally complete canonical geometric shapes is already
nascent in early infancy [@kellman1983perception;
@valenza2006perceptual], yet there is currently no data on when children
may be able to use pars pro toto cues in an object-choice context.
...
euqipped to successfully apply their implicit and explicit numerical
...
From this overview, several research desidarata emerge. The prevailing
...
challenging than Representation due to the completion required, and form
analogies being relatively abstract, our preregistered hypothesis was
that as a group, children will first succeed with *Representation*, then
*Pars Pro Toto*, *Simple Form Analogy* and finally *Complex Form
Analogy*.
...
most difficult condition in this series of studies. Success herer
equires shifting attention from general appearance to nested object
