...
and sound symbolism and with children from infancy to up to the
preschool years [@callaghan2015development].

A central paradigm in this line of work is the symbolic object-choice
task. In a typical procedure, an experimenter invites a child to play a
game of hide and seek. First children are familiarized with the goal of
the hiding game - retrieving a desired object from one of two
containers - during a set of initial trials in which that object may be
hidden in plain sight and child is praised for uncovering it. During the
test phase, children cannot observe where the desired item is hidden.
They are now motivated to search but naive with regard to the hiding
place. During test trials, the experimenter will now provide some from
of communicative cue guiding children's choices. Now, children are
provided access to the containers and to choose either option. In order
to probe children's developing appreciation for various forms of
symbolic behavior, researchers have used communicative cues such as gaze
and reaching [@sodian2004infants], pointing [@Tomasello2007new;
@behne2012twelve], arrows, markers and replica [@Leekam2010adults,
@Tomasello1997comprehension, @callaghan2000factors], iconic gestures
[@Tomasello1999do], fotos, drawings [@Callaghan2000factors] or even
switching on a light [@moore2013three].

In a standard analysis of this paradigm [@tomasello2010origins],
children are required to make several inferences. They need keep in mind
the goal of finding the target while construing the situation as a
cooperative joint endeavor and perceiving their partner as intent on and
competent in helping them. This forms the basis for appreciating the cue
provided as relevant to their goal of finding the desired item. In order
to arrive at the correct container, they further then need to match cue
and target object. To do so, the experimenters cue is not is not just a
random act or object but serves as a means to coordinate behavior, and
hence becomes symbolic. The symbol-referent relationship may be based in
deictic reference (pointing, arrows, markers), iconicity (replica,
iconic gesture) or at least some peculiar spatio-temporal contiguity
(turning on a light), but simply discovering some form of similarity or
contiguity does not suffice. To motivate appropriate behavior, children
are required infer a match between cue and target and make the
communicative inference of its particular relevance in context.

While there is a set of naturally meaningful behaviors such as pointing
and gaze, that children understand at the end of the third your, less
natural behavior external means of communication are understood much
later. The work of Judy DeLoache and colleagues has been of seminal
importance in sketching children’s ability to exploit the informative
value of symbolic artefacts. In various studies, they have prompted
children to find the location of a hidden toy by providing them with
cues in the form of scale models, pictures, videos and maps representing
a search space [@deloache2004becoming]. Whereas even 30-month-old
children fail to retrieve hidden items by using instructions based on
replicas like a model-room, 36-month-olds excel. This pattern of results
in symbolic object-choice-tasks has been replicated many times by her
group and other labs [@deloache2011early] and demonstrates that
children’s symbolic understanding undergoes a rapid development in the
third year of life [@deloache2004becoming; @callaghan2015development].
...
used as cue and target. To the extent that children are highly unlikely
to have encountered the specific graphic cues used here, our findings
showcase their ability to grasp and acquire novel symbol-referent
pairings. This may limit the influence of children’s knowledge of
conventional symbols on performance and make results more robust and
