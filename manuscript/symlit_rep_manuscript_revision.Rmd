...
basically iconic, yet only showing a part or aspect of the referent. At
...
used as target and referent. To the extent that children are highly
unlikely to have encountered the specific graphic cues used here, our
findings showcase their ability to grasp a novel symbolic practice and
acquire novel symbols. This may limit the influence of children’s
...
between the two barriers. The drawing served as a cue to guide
...
test trials. Unique graphic displays were used on every trial. Test
...
the referent, and the identity of the cue are counterbalanced. For the
...
coded as correct or incorrect by the experimental script. The analyses
...
outline drawing, of the referent. The second condition, *Pars Pro Toto,*
...
either of the two target referents. To prevent learning or demand
effects across trials, children did not receive feedback on their
choices and were presented with a novel stimulus pairing in each trial.
...
stimulus sets where symbol and referent feature different shapes but are
...
with one or three items per target or referent. Number of Feature reuses
