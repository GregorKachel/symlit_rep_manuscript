...
learning, each yielding profound consequences for children's cognitive
...
ontogeny of symbolic appreciation, ranging from social signals like gaze
and reaching [@sodian2004infants] or pointing [@Tomasello2007new;
@behne2012twelve] to more abstract or iconic referents such as arrows,
markers, replicas [@Leekam2010adults; @Tomasello1997comprehension;
@callaghan2000factors], iconic gestures [@Tomasello1999do;
@bohn2019natural], photographs [@callaghan2000factors], and arbitrary
...
structural match between cue and target and a functional grasp of the
cue’s symbolic intent.
...
evident in the domain of graphic representation: functional use of
graphic representations in choice tasks remains fragile until
approximately age three. For instance, while children as young as 2.5
years may use shape to interpret drawings when intentionality is clear
[@gelman1998shape], Callaghan [-@callaghan1999early] found that
two-year-olds still struggle to select items based on representative
drawings. This fragility is underscored by findings that 30-month-olds
often fail to benefit from iconicity in either drawings or replicas,
whereas 36-month-olds reliably succeed in object-choice-tasks across
varying levels of stylization [@callaghan2000factors;
@DeLoache1995early].
...
principles for encoding information in the graphic domain
...
To explore the continuum from iconic or representational to more
conceptual and abstract symbol-referent relationships in step-wise
manner, it will be helpful to gradually reduce resemblance between cue
and target. As an alternative to using varying levels of realism in
designing communicative cues [@callaghan2000factors], it also possible
to reduce cues such that they only present part of their respective
target as often occurs naturally when streamlining communication and
developing conventions [@goldin1977development]. Part-whole
relationships on the level of geometric figures could be an ideal target
for an investigation into slightly abstract symbol-reference
relationships as shape recognition and naming are robust in the third
and fourth year [@ZAMBRZYCKA2017144; @verdine2017shape;
@verdine2016shape] and the ability to mentally complete canonical
geometric shapes is already nascent in early infancy
...
such as using sharp or spiky drawings to refer to "pointy" concepts
[@knoeferle2017drives]. This phenomenon is central to research on sound
symbolism within the lexicon [@bermudez2020sound; @sidhu2025sound], as
well as in studies of action and gesture [@margiotoudi2020action;
@bohn2019natural]. Robust across cultures [@cwiek2022bouba], this
sensitivity emerges around 30 months for word-shape matching
[@maurer2006shape; @imai2008sound; @fort2018symbouki] and by 36 months
for matching actions with vocalizations or gestures [@bohn2019natural].
Despite these findings, it remains unknown whether children can utilize
the global properties or "impressions" of a shape’s form to ground
reference in the graphic domain alone.
...
the developing ability to read maps. While four-year-olds possess an
...
[@ifrah2000universal; @cooperrider2019career]. Sensitivity to number
develops from an infant’s implicit grasp of proximate numerical
...
[@silver2022environmental; @carey2019ontogenetic]. This allows them to
apply numerical knowledge in practical contexts, such as comparing
magnitudes smaller than five [@wynn1990children; @eckert2022does].
...
probing these matching dimensions. While shapes in match-to-sample (MTS)
tasks poses little challenge for children beyond age three
[@kroupin2022you; @gerhardstein2002development], utilizing relational
dimensions like size or number remains difficult. Even by age four,
children rarely spontaneously infer size as a matching criterion in
three-item MTS arrays, and success in number-based matching typically
...
terms *same* and *different* [@christie2014language].

A critical distinction exists between these paradigms and symbolic
object-choice tasks. In MTS/RMTS, children are explicitly instructed to
find matches as an end in itself. Conversely, the object-choice context
...
The prevailing literature’s heavy reliance on similarity and iconicity
[@callaghan2015development] leaves the broader scope of children’s
symbolic flexibility largely unexplored. Because most studies employ
depictions of real-world objects, results may be confounded by
children’s familiarity with canonical features [@long2019real] or
cultural graphic conventions. To address these research desiderata, the
present work provides a systematic investigation into the diverse
conceptual dimensions along which graphic symbols can be imbued with
meaning and traces development continuously through the pre-school years
employing the symbolic object-choice task as one coherent and simple
paradigm. By utilizing novel abstract graphic displays as both cue and
target, this study isolates children’s ability to identify conceptual
features and apply pragmatic inferences in context, largely independent
of prior knowledge of script, numerals, or conventional icons.
Furthermore, by omitting training, instruction, or feedback, our
