...
add_colour <- function(df) {
  df %>% mutate(colour = condition_colours[condition])
}
...
```{r rep_S1_bayes_fullmodel_plotting_new, echo=FALSE, eval=T, warning = F, message=F}
# packages -----------
# library(patchwork)
# library(magick)
# library(grid)
...
```{r rep_S1_bayes_fullmodel_plotting, echo=FALSE, eval=T, warning = F, message=F}
