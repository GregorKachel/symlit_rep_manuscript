...
# Problematic ids
# 263126 study1 but should be study2
# 262944 study2 but should be study1 
# drops within oversampling are a problem!
# if trial = fam --> condition = familiarisation

# study2 but should be study 1 1111990176
# study1 but should be study 2 1112759854
...
f2 <- fitted(S2.full.bm, 
  ...
  as_tibble() %>%
  bind_cols(nd2)%>%
  mutate(age = z.age + mean(S2.bayes.data$ageinyears)) # convert age back to the original scale by adding the mean of the data
