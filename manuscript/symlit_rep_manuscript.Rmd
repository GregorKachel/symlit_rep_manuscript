...
An exploratory model with additional item-level random effects showed that item variation was 
Item intercept 
($\beta$ = `r S1.item.coef["sd_item__Intercept", "mean"]`, 95% CrI
[`r S1.item.coef["sd_item__Intercept", "q2.5"]`,
`r S1.item.coef["sd_item__Intercept", "q97.5"]`)

and the age effect varied slightly across items 
($\beta$ = `r S1.item.coef["sd_item__z.age", "mean"]`, 95% CrI
[`r S1.item.coef["sd_item__z.age", "q2.5"]`,
`r S1.item.coef["sd_item__z.age", "q97.5"]`)

The correlation between item difficulty and item-specific age slopes was uncertain 
(ρ = `r S1.item.coef["cor_item__Intercept__z.age", "mean"]`, 95% CrI
[`r S1.item.coef["cor_item__Intercept__z.age", "q2.5"]`,
`r S1.item.coef["cor_item__Intercept__z.age", "q97.5"]`)

Comparing the models using weights based on the Widely Applicable Information Criterion (WAIC) yielded
full model `r round(S1.itemvsfull.weights["S1.full.bm","value"]*100,2)`% 
null model `r round(S1.itemvsfull.weights["S1.item.model","value"]*100,2)`% 

Directly comparing the models' WAIC via expected log predictive density (ELPD) corroborates this 
(ELPD WAIC; 
full model = `r round(S1.itemvsfull.comp["S1.full.bm", "elpd_waic"],2)`; 
item model = `r round(S1.itemvsfull.comp["S1.item.model", "elpd_waic"],2)`). 
The standard error of the difference in predictive accuracy 
(SE =`r round(S1.itemvsfull.comp["S1.item.model", "se_diff"],2)`) is not much larger than the difference itself (ELPD diff = `r round(S1.itemvsfull.comp["S1.item.model", "elpd_diff"],2)`).

For on overview of item level logg odds see figure \@ref(fig:plot-study123itemintercepts)
For coefficients see table \@ref(tab:suppl-S1item-coef-table)
...
An exploratory model with additional item-level random effects showed that item variation was 
Item intercept 
($\beta$ = `r S2.item.coef["sd_item__Intercept", "mean"]`, 95% CrI
  [`r S2.item.coef["sd_item__Intercept", "q2.5"]`,
    `r S2.item.coef["sd_item__Intercept", "q97.5"]`)

and the age effect varied slightly across items 
($\beta$ = `r S2.item.coef["sd_item__z.age", "mean"]`, 95% CrI
  [`r S2.item.coef["sd_item__z.age", "q2.5"]`,
    `r S2.item.coef["sd_item__z.age", "q97.5"]`)

The correlation between item difficulty and item-specific age slopes was uncertain 
(ρ = `r S2.item.coef["cor_item__Intercept__z.age", "mean"]`, 95% CrI
  [`r S2.item.coef["cor_item__Intercept__z.age", "q2.5"]`,
    `r S2.item.coef["cor_item__Intercept__z.age", "q97.5"]`)

Comparing the models using weights based on the Widely Applicable Information Criterion (WAIC) yielded
full model `r round(S2.itemvsfull.weights["S2.full.bm","value"]*100,2)`% 
null model `r round(S2.itemvsfull.weights["S2.item.model","value"]*100,2)`% 

Directly comparing the models' WAIC via expected log predictive density (ELPD) corroborates this 
(ELPD WAIC; 
full model = `r round(S2.itemvsfull.comp["S2.full.bm", "elpd_waic"],2)`; 
item model = `r round(S2.itemvsfull.comp["S2.item.model", "elpd_waic"],2)`). 
The standard error of the difference in predictive accuracy 
(SE =`r round(S2.itemvsfull.comp["S2.item.model", "se_diff"],2)`) is not much larger than the difference itself (ELPD diff = `r round(S2.itemvsfull.comp["S2.item.model", "elpd_diff"],2)`).

For on overview of item level logg odds see figure \@ref(fig:plot-study123itemintercepts)
For coefficients see table \@ref(tab:suppl-S2item-coef-table)
...
An exploratory model with additional item-level random effects showed that item variation was 
Item intercept 
($\beta$ = `r S3.item.coef["sd_item__Intercept", "mean"]`, 95% CrI
  [`r S3.item.coef["sd_item__Intercept", "q2.5"]`,
    `r S3.item.coef["sd_item__Intercept", "q97.5"]`)

and the age effect varied slightly across items 
($\beta$ = `r S3.item.coef["sd_item__z.age", "mean"]`, 95% CrI
  [`r S3.item.coef["sd_item__z.age", "q2.5"]`,
    `r S3.item.coef["sd_item__z.age", "q97.5"]`)

The correlation between item difficulty and item-specific age slopes was uncertain 
(ρ = `r S3.item.coef["cor_item__Intercept__z.age", "mean"]`, 95% CrI
  [`r S3.item.coef["cor_item__Intercept__z.age", "q2.5"]`,
    `r S3.item.coef["cor_item__Intercept__z.age", "q97.5"]`)

Comparing the models using weights based on the Widely Applicable Information Criterion (WAIC) yielded
full model `r round(S3.itemvsfull.weights["S3.full.bm","value"]*100,2)`% 
null model `r round(S3.itemvsfull.weights["S3.item.model","value"]*100,2)`% 

Directly comparing the models' WAIC via expected log predictive density (ELPD) corroborates this 
(ELPD WAIC; 
full model = `r round(S3.itemvsfull.comp["S3.full.bm", "elpd_waic"],2)`; 
item model = `r round(S3.itemvsfull.comp["S3.item.model", "elpd_waic"],2)`). 
The standard error of the difference in predictive accuracy 
(SE =`r round(S3.itemvsfull.comp["S3.item.model", "se_diff"],2)`) is not much larger than the difference itself (ELPD diff = `r round(S3.itemvsfull.comp["S3.item.model", "elpd_diff"],2)`).

For on overview of item level logg odds see figure \@ref(fig:plot-study123itemintercepts)
For coefficients see table \@ref(tab:suppl-S3item-coef-table)
