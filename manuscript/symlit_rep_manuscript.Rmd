...
appendix: # to change filenames, also see end of s
...
```{r S1S2S3_itemvsfull_comp, echo=FALSE, eval=T, warning = F, message=F}
...
```{r plot-figure-setup, fig.cap = "*Setup.* Experimenters were sitting behind the children in order to not distract them while supervising data collection.", fig.align = "center", echo = FALSE, out.width = "98%"}
