...
add_colour <- function(df) {
  df %>%
    mutate(colour = case_when(
      condition == "Representation" ~ "#006400",
      condition == "Pars Pro Toto" ~ "#79e000",
      condition == "Simple Form Analogy" ~ "#ff9609",
      condition == "Complex Form Analogy" ~ "#ffc512",
      condition == "Absolute Position" ~ "#4B0082",
      condition == "Relative Position" ~ "#6A5ACD",
      condition == "Orientation of Object" ~ "#8B0000",
      condition == "Orientation of Feature" ~ "#A0522D",
      condition == "Size of Object" ~ "#191970",
      condition == "Size of Feature" ~ "#008080",
      condition == "Number of Object" ~ "#800080",
      condition == "Number of Feature" ~ "#8B008B",
      TRUE ~ NA_character_
    ))
}
...
For a conventional analysis binning participants according to their age in years, please see table \@ref(tab:suppl-descriptives-S1) in appendix C.

(ref:study1plot-caption) Study 1 - Developmental Trajectories.

```{r figure-study1plot, fig.cap = "(ref:study1plot-caption)", fig.align = "center", echo = FALSE}

knitr::include_graphics("../illustrations/plot_study1.png", dpi = 108)
...
(ref:study2plot-caption) Study 2 - Developmental Trajectories.

```{r figure-study2plot, fig.cap = "(ref:study2plot-caption)", fig.align = "center", echo = FALSE}

knitr::include_graphics("../illustrations/plot_study2.png", dpi = 108)
...
(ref:study3plot-caption) Study 3 - Developmental Trajectories.

```{r figure-study3plot, fig.cap = "(ref:study3plot-caption)", fig.align = "center", echo = FALSE}

knitr::include_graphics("../illustrations/plot_study3.png", dpi = 108)
