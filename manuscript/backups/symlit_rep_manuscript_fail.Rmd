...
```{r plot-prep-participants-dots, echo = F, warning=F}
...
```{r plot-prep-exclusions-dots, echo = F, warning=F}
...
```{r S1S2S3_item_model, echo=FALSE, eval=FALSE}
...
```{r S1S2S3_item_ppcheck_rhat_bulkESS, echo=FALSE, eval=T}
# read in models
...
```{r S1_itemvsfull_comp, echo=F, eval= T}
...
second year of life [@Tomasello2008origins; @tomasello2009cultural;
@tomasello2010origins]. While at first lacking an understanding of the
...
@tomasello1999young; @tomasello1997comprehension]. Notably, symbolic
...
@ref(fig:plot-participants-dots)). All participants were recruited in
...
figures \@ref(fig:plot-participants-dots) and
...
```{r total_participants, eval=F, echo=F}
...
```{r plot-participants-dots, fig.cap = "Distribution of Participants across the age-range in all three studies. Dots represent individuals. Colors indicate their respective sex.", fig.align = "center", echo = FALSE, out.width = "80%"}

knitr::include_graphics(knitr::plot_crop("../illustrations/plot_supp_participants_S123.png"))

```

```{r plot-exclusions-dots, fig.cap = "Distribution of Exclusions across the age-range in all three studies. Dots represent individuals. Colors indicate why children where not submitted to analyses.", fig.align = "center", echo = FALSE, out.width = "70%"}
