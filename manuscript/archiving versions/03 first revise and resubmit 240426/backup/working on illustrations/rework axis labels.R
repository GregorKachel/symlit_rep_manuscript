...
S1_complete <- ggdraw() +
  ...
  draw_plot_label(label = "B", size = 13, x = 0, y = 0.65) +
  draw_plot_label(label = "C", size = 13, x = 0, y = 0.26) +
  draw_plot_label(label = "Cue", size = 13, x = 0.1, y = 0.3, angle = 90) +
  draw_plot_label(label = "Target", size = 13, x = 0.1, y = 0.2, angle = 90 ) +
  draw_plot_label(label = "Proportion Correct", size = 13, x = 0.05, y = 0.1, angle = 90) +
  draw_plot_label(label = "Age in Years", size = 13, x = 0.45, y = 0.05) 
  

S1_complete + canvas(width=27, height= 17, 
                     units="cm", dpi = 600)
...
S1_complete <- ggdraw() +
  ...
  draw_plot_label(label = "Age in Years", size = 12, x = 0.44, y = 0.04) +
